...
type Product = RegularProduct | DigitalBook;
...
export function ProductDetailsModal({
  ...
  const stockStatus = regularProduct ? getStockStatus(regularProduct.stock) : null;
        ...
        <div className="overflow-y-auto flex-1 px-6 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300 dark:scrollbar-track-gray-800 dark:scrollbar-thumb-gray-600">
          {loading ? (
            ...
            <div className="space-y-6 py-2">
              ...
              {!isDigitalBook && regularProduct?.images && regularProduct.images.length > 0 && (
                <Card className="overflow-hidden border-gray-200 dark:border-gray-800">
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="p-2 bg-[#8a5d95]/30 dark:bg-[#8a5d95]/30 rounded-lg">
                    ...
                    <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-6 gap-3">
                      {regularProduct.images.map((image: string, index: number) => (
                        <div key={index} className="group relative aspect-square">
                          {!failedImages.has(index) ? (
                            <Image
                              src={
                ...
                <Card className="overflow-hidden border-gray-200 dark:border-gray-800">
                  <CardContent className="p-6">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                      {digitalBook.overviewImages.map((image: string, index: number) => (
                        <div key={index} className="group relative aspect-square">
                          <Image
                            src={image}
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
                ...
                <Card className="border-gray-200 dark:border-gray-800">
                  <CardContent className="p-4">
                    <h3 className="text-xl font-semibold text-[#511d5e] dark:text-gray-100 mb-3">
                      {isDigitalBook ? "Pricing & Availability" : "Pricing & Stock"}
                    </h3>
                    ...
                    <div className="space-y-3">
                      ...
                      {isDigitalBook && digitalBook && (
                        <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800">
                          <div className="flex items-center gap-2">
                            <div className={`p-1.5 rounded-md ${
                              digitalBook.isAvailable ? 'bg-green-500' : 'bg-red-500'
                            }`}>
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-1">
                                <Badge variant={digitalBook.isAvailable ? "default" : "destructive"} className="text-xs px-2 py-1">
                ...
                <Card className="xl:col-span-2 border-gray-200 dark:border-gray-800">
                  <CardContent className="p-4">
                    <h3 className="text-xl font-semibold text-[#511d5e] dark:text-gray-100 mb-3">
                      {isDigitalBook ? "Book Information" : "Product Information"}
                    </h3>
                      ...
                      {isDigitalBook && digitalBook && (
                        <>
                          ...
                          <div className="flex items-center gap-2 p-4 bg-gray-50 dark:bg-gray-900 rounded-md">
                            ...
                            <div>
                              <span className="text-xs text-gray-500 dark:text-gray-400 font-medium">Genre</span>
                              <p className="text-xs font-semibold text-gray-900 dark:text-gray-100">
                                {digitalBook.genre}
                              </p>
                            </div>
                          ...
                          <div className="flex items-center gap-2 p-4 bg-gray-50 dark:bg-gray-900 rounded-md">
                            ...
                            <div>
                              <span className="text-xs text-gray-500 dark:text-gray-400 font-medium">Release Date</span>
                              <p className="text-xs font-semibold text-gray-900 dark:text-gray-100">
                          ...
                          <div className="flex items-center gap-2 p-2 bg-blue-50 dark:bg-blue-950/20 rounded-md border border-blue-200 dark:border-blue-800">
                            ...
                            <div>
                              <span className="text-xs text-blue-600 dark:text-blue-400 font-medium">Access Link</span>
                              <div className="flex items-center gap-2 mt-1">
                                ...
                                >
                                  <a href={digitalBook.url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                {!isDigitalBook && regularProduct?.tags && regularProduct.tags.length > 0 && (
                  <Card className="border-gray-200 dark:border-gray-800">
                    <CardContent className="p-4">
                      <h3 className="text-xl font-semibold text-[#511d5e] dark:text-gray-100 mb-3">
                        Tags
                      ...
                      <div className="flex flex-wrap gap-1">
                        {regularProduct.tags.map((tag: string, index: number) => (
                          <Badge
                            key={index}
                            variant="secondary"
                            className="px-4 py-0.5 text-base bg-[#8a5d95]/30 dark:bg-[#8a5d95]/30 text-black/80 hover:bg-[#8a5d95]/90 dark:text-[#8a5d95] hover:bg-[#8a5d95]/20 border-[#8a5d95]/60 dark:border-black/60"
                    ...
                    <div className="space-y-2">
                      ...
                      {isDigitalBook && digitalBook?.releaseDate && (
                        <div className="flex items-center gap-2 p-2 bg-purple-50 dark:bg-purple-950/20 rounded-md border border-purple-200 dark:border-purple-800">
                          ...
                          <div>
                            <span className="text-xs text-purple-600 dark:text-purple-400 font-medium">Released</span>
            ...
            <div className="flex flex-col items-center justify-center py-20 space-y-4">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Unable to load {isDigitalBook ? 'book' : 'product'} details. Please try again.
                </p>
              </div>
            </div>
          )}
